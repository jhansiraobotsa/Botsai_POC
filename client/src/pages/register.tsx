                    ...
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent className="bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-600">
                          ...
                          <SelectItem value="premium" className="text-slate-900 dark:text-white">Premium - $49/month</SelectItem>
                          <SelectItem value="enterprise" className="text-slate-900 dark:text-white">Enterprise - $199/month</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage />
                    </FormItem>
